  ...
  **Entendendo os Padrões Dependency Injection (Injeção de Dependência) e Unit Of Work (Unidade de Trabalho)**
  ...
  Sumário
    ...
    -  Dependency Injection ou Injeção de Dependência: É um padrão de projeto de software que visa reduzir o
     ...
     - Repository ou Repositório: Padrão que provê uma camada de acesso por outras camadas da aplicação com os dados
     ...
     -  Unit of work ou unidade de trabalho: Padrão utilizado para definir e a gerenciar as transações de uma
     aplicação.
